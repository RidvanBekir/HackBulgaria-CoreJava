...
public class WebCrawler {
    ...
    public Set<URI> crawl(URI currentLocation, final String needle) throws URISyntaxException, MalformedURLException,
        ...
        }
        {
            ...
            for (String link : allLinks) {
                ...
                if (asUri != null && !visitedUrls.contains(asUri) && isInsideDomain(currentLocation, asUri)) {
